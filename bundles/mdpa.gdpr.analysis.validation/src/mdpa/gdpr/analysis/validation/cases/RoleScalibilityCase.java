...
public class RoleScalibilityCase extends AbstractScalibilityCase {
    ...
    public void runScalibilityCase(ScalibilityParameter parameter, AnalysisExecutor analysisExecutor) {
        ...
        /*
         * Property property = builder.createProperty("Type", List.of("True", "False")); PropertyAnnotation propertyAnnotation =
         * builder.createPropertyAnnotation(builder.getDefaultPersonalData(), property); ContextAnnotation contextAnnotation =
         * builder.createContextAnnotation("Annotation", List.of(property.getPropertyvalue().get(0)), propertyAnnotation);
