...
public class ScalibilityCaseRunner {
	...
	private void saveResults(String testName) {
		try {
			FileOutputStream fileOutputStream
		      = new FileOutputStream(ScalibilityCaseRunner.BASE_PATH + "/results/" + testName + ".ser");
	...
	public static List<AbstractScalibilityCase> getTests() {
		return List.of(
				new ContextDefinitionAmountScalibilityCase(),
				new ContextDefinitionSizeScalibilityCase(),
				new DataDefinedContextDependentAttributeScalibilityCase(),
				new DataScalibilityCase(),
				new DataUndefinedContextDependentAttributeScalibilityCase(),
				new NodeDefinedContextDependentAttributeScalibilityCase(),
				new NodeUndefinedContextDependentAttribute(),
				new PropagationScalibilityCase(),
				new PurposeScalibilityCase(),
